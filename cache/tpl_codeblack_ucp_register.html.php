...
<?php if ($this->_rootref['S_ABQ_CODE']) {  ?>

<tr>
<td class="row1"><b class="genmed"><?php echo ((isset($this->_rootref['L_AB_QUESTION'])) ? $this->_rootref['L_AB_QUESTION'] : ((isset($user->lang['AB_QUESTION'])) ? $user->lang['AB_QUESTION'] : '{ AB_QUESTION }')); ?>:</b><br /><span class="gensmall"><?php echo ((isset($this->_rootref['L_AB_QUESTION_EXPLAIN'])) ? $this->_rootref['L_AB_QUESTION_EXPLAIN'] : ((isset($user->lang['AB_QUESTION_EXPLAIN'])) ? $user->lang['AB_QUESTION_EXPLAIN'] : '{ AB_QUESTION_EXPLAIN }')); ?></span></td>
<td class="row2"><input class="post" type="text" name="AB_Question" size="25" maxlength="100" value="<?php echo (isset($this->_rootref['AB_QUESTION'])) ? $this->_rootref['AB_QUESTION'] : ''; ?>" /></td>
</tr>
<?php } ?>
...
<?php }} if ($this->_rootref['S_CONFIRM_CODE']) {  ?>
	...
	<tr>
		<th colspan="2" valign="middle"><?php echo ((isset($this->_rootref['L_CONFIRMATION'])) ? $this->_rootref['L_CONFIRMATION'] : ((isset($user->lang['CONFIRMATION'])) ? $user->lang['CONFIRMATION'] : '{ CONFIRMATION }')); ?></th>
	</tr>
	<tr>
	...
	<tr>
		<td class="row1" colspan="2" align="center"><?php echo (isset($this->_rootref['CONFIRM_IMG'])) ? $this->_rootref['CONFIRM_IMG'] : ''; ?></td>
	</tr>
	<tr>
