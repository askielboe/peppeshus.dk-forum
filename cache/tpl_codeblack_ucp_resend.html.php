...
<tr>
	<th colspan="2"><?php echo ((isset($this->_rootref['L_UCP_RESEND'])) ? $this->_rootref['L_UCP_RESEND'] : ((isset($user->lang['UCP_RESEND'])) ? $user->lang['UCP_RESEND'] : '{ UCP_RESEND }')); ?></th>
</tr>
<tr>
...
<tr>
	...
	<td class="row2"><input type="text" class="post" name="email" size="25" maxlength="255" value="<?php echo (isset($this->_rootref['EMAIL'])) ? $this->_rootref['EMAIL'] : ''; ?>" /></td>
</tr>
<tr>
