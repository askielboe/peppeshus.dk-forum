...
<?php if ($this->_rootref['QUICK_REPLY']) {  ?>

<tr>
	<td class="row1" width="50%"><b class="genmed"><?php echo ((isset($this->_rootref['L_QUICK_REPLY_DISPLAY'])) ? $this->_rootref['L_QUICK_REPLY_DISPLAY'] : ((isset($user->lang['QUICK_REPLY_DISPLAY'])) ? $user->lang['QUICK_REPLY_DISPLAY'] : '{ QUICK_REPLY_DISPLAY }')); ?>:</b></td>
	<td class="row2"><input type="radio" class="radio" name="quickreply" value="1"<?php if ($this->_rootref['S_QUICKREPLY']) {  ?> checked="checked"<?php } ?> /><span class="gen"><?php echo ((isset($this->_rootref['L_YES'])) ? $this->_rootref['L_YES'] : ((isset($user->lang['YES'])) ? $user->lang['YES'] : '{ YES }')); ?></span>&nbsp; &nbsp;<input type="radio" class="radio" name="quickreply" value="0"<?php if (! $this->_rootref['S_QUICKREPLY']) {  ?> checked="checked"<?php } ?> /><span class="gen"><?php echo ((isset($this->_rootref['L_NO'])) ? $this->_rootref['L_NO'] : ((isset($user->lang['NO'])) ? $user->lang['NO'] : '{ NO }')); ?></span></td>
</tr>
<?php } if ($this->_rootref['QUICK_POST']) {  ?>

<tr>
	<td class="row1" width="50%"><b class="genmed"><?php echo ((isset($this->_rootref['L_QUICK_POST_DISPLAY'])) ? $this->_rootref['L_QUICK_POST_DISPLAY'] : ((isset($user->lang['QUICK_POST_DISPLAY'])) ? $user->lang['QUICK_POST_DISPLAY'] : '{ QUICK_POST_DISPLAY }')); ?>:</b></td>
	<td class="row2"><input type="radio" class="radio" name="quickpost" value="1"<?php if ($this->_rootref['S_QUICKPOST']) {  ?> checked="checked"<?php } ?> /><span class="gen"><?php echo ((isset($this->_rootref['L_YES'])) ? $this->_rootref['L_YES'] : ((isset($user->lang['YES'])) ? $user->lang['YES'] : '{ YES }')); ?></span>&nbsp; &nbsp;<input type="radio" class="radio" name="quickpost" value="0"<?php if (! $this->_rootref['S_QUICKPOST']) {  ?> checked="checked"<?php } ?> /><span class="gen"><?php echo ((isset($this->_rootref['L_NO'])) ? $this->_rootref['L_NO'] : ((isset($user->lang['NO'])) ? $user->lang['NO'] : '{ NO }')); ?></span></td>
</tr>
