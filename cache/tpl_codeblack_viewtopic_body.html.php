...
<?php $_postrow_count = (isset($this->_tpldata['postrow'])) ? sizeof($this->_tpldata['postrow']) : 0;if ($_postrow_count) {for ($_postrow_i = 0; $_postrow_i < $_postrow_count; ++$_postrow_i){$_postrow_val = &$this->_tpldata['postrow'][$_postrow_i]; ?>
	...
	<?php } else { ?>
			...
			<td align="center" valign="middle">
				...
				<b class="postauthor"<?php if ($_postrow_val['POST_AUTHOR_COLOUR']) {  ?> style="color: <?php echo $_postrow_val['POST_AUTHOR_COLOUR']; ?>"<?php } ?>><font size=3><a href="<?php echo $_postrow_val['U_PROFILE']; ?>"><?php echo $_postrow_val['POST_AUTHOR']; ?></a></font></b>
			</td>
			<td width="100%" height="25">
				...
				<?php } ?>
					...
					<td class="gensmall" width="100%"><div style="float: <?php echo (isset($this->_rootref['S_CONTENT_FLOW_END'])) ? $this->_rootref['S_CONTENT_FLOW_END'] : ''; ?>;"><?php if ($this->_rootref['S_IS_BOT']) {  echo $_postrow_val['MINI_POST_IMG']; } else { ?><a href="<?php echo $_postrow_val['U_MINI_POST']; ?>"><?php echo $_postrow_val['MINI_POST_IMG']; ?></a><?php } ?><b><?php echo ((isset($this->_rootref['L_POSTED'])) ? $this->_rootref['L_POSTED'] : ((isset($user->lang['POSTED'])) ? $user->lang['POSTED'] : '{ POSTED }')); ?>:</b> <?php echo $_postrow_val['POST_DATE']; ?>&nbsp;</div></td>
				</tr>
				</table>
			</td>
		</tr>
				...
				<tr>
					...
					<?php } if (! $_postrow_val['S_HAS_ATTACHMENTS']) {  ?><br clear="all" /><br /><?php } ?>
						...
						<tr valign="middle">
							...
							<?php if (! $this->_rootref['S_IS_BOT']) {  if ($_postrow_val['U_EDIT']) {  ?><a href="<?php echo $_postrow_val['U_EDIT']; ?>"><?php echo (isset($this->_rootref['EDIT_IMG'])) ? $this->_rootref['EDIT_IMG'] : ''; ?></a> <?php } if ($_postrow_val['U_QUOTE']) {  ?><a href="<?php echo $_postrow_val['U_QUOTE']; ?>"><?php echo (isset($this->_rootref['QUOTE_IMG'])) ? $this->_rootref['QUOTE_IMG'] : ''; ?></a> <?php } if ($this->_rootref['QUICK_REPLY']) {  ?><a href="#postform" onclick="addquote(<?php echo $_postrow_val['POST_ID']; ?>,'<?php echo $_postrow_val['POSTER_QUOTE']; ?>'); insert_text('\n'); return false;" title="<?php echo ((isset($this->_rootref['L_QUOTE_QUICK_TEXT'])) ? $this->_rootref['L_QUOTE_QUICK_TEXT'] : ((isset($user->lang['QUOTE_QUICK_TEXT'])) ? $user->lang['QUOTE_QUICK_TEXT'] : '{ QUOTE_QUICK_TEXT }')); ?>"><?php echo (isset($this->_rootref['QUOTE_QUICK_IMG'])) ? $this->_rootref['QUOTE_QUICK_IMG'] : ''; ?></a> <?php } if ($_postrow_val['U_REPORT']) {  ?><a href="<?php echo $_postrow_val['U_REPORT']; ?>"><?php echo (isset($this->_rootref['REPORT_IMG'])) ? $this->_rootref['REPORT_IMG'] : ''; ?></a> <?php } if ($_postrow_val['U_INFO']) {  ?><a href="<?php echo $_postrow_val['U_INFO']; ?>"><?php echo (isset($this->_rootref['INFO_IMG'])) ? $this->_rootref['INFO_IMG'] : ''; ?></a> <?php } if ($_postrow_val['U_WARN']) {  ?><a href="<?php echo $_postrow_val['U_WARN']; ?>"><?php echo (isset($this->_rootref['WARN_IMG'])) ? $this->_rootref['WARN_IMG'] : ''; ?></a> <?php } if ($_postrow_val['U_DELETE']) {  ?><a href="<?php echo $_postrow_val['U_DELETE']; ?>"><?php echo (isset($this->_rootref['DELETE_IMG'])) ? $this->_rootref['DELETE_IMG'] : ''; ?></a> <?php } } ?>
...
<?php }} ?>
	...
	<?php if ($this->_rootref['QUICK_REPLY']) {  $this->_tpl_include('quick_reply.html'); } ?>
